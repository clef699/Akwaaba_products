  ...
  return (
    <form onSubmit={handleSubmit} className="p-9">
      <div className="flex items-center gap-4 mb-1">
        ...
        <div>
          <h1 className="text-[24px] font-bold text-[#0a0a0a]">Add New Product</h1>
          <p className="text-[13px] text-[#888] mt-0.5">Fill in the details to list a new product</p>
        </div>
      ...
      <div className="mt-5 mb-6 bg-[#efefef] border border-[#c8e6c9] rounded-[8px] px-4 py-2.5 flex items-center gap-2">
        <span className="text-[12px]">🌾</span>
        <p className="text-[12px] font-medium text-[#3d9140]">
          This product will be listed under your vendor store.
        </p>
      </div>
